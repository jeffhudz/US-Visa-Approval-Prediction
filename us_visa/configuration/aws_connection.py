import boto3
import os
from us_visa.constants import AWS_ACCESS_ID_ENV_KEY, AWS_SECRET_ACCESS_KEY_ENV_KEY,REGION_NAME
    ...
    def __init__(self, region_name=REGION_NAME):
        ...
        if s3Client.s3_resource==None or s3Client.s3_client==None:
            ...
            if __access_key_id is None:
                raise Exception(f"Environment variable: {AWS_ACCESS_ID_ENV_KEY} is not not set.")
